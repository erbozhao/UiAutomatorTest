...
public class SlideNewsTab extends PerCommon {

    private File resultFolder = new File(perFolder, "common");
    private String scenesName = "slidetab_news";
    ...
    public void testCpuFpsOpera() {
        testBrowser(NEWS_OPERA, true, true);
    }

    @Test
    public void testCpuFpsScooper() {
        testBrowser(NEWS_SCOOPER, true, true);
    }

    @Test
    public void testCpuFpsToutiao() {
        testBrowser(NEWS_TOUTIAO, true, true);
    }
